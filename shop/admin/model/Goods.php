...
class Goods{
	...
	public function add_goods($data){		
			...
			$goods['pay_number']=$data['pay_number'];
			$goods['is_coupon']=$data['is_coupon'];
			$goods['retail_price']=$data['retail_price'];
			$goods['is_points_goods']=$data['is_points_goods'];
			$goods['is_number_goods']=$data['is_number_goods'];
			$goods['is_yue_goods']=$data['is_yue_goods'];
			$goods['is_tuijian']=$data['is_tuijian'];
			$goods['modelis'] = $data['modelis'];
			...
			// }	
			// if($goods['pay_number']>0){
			// 	$goods['is_number_goods']=1;
			// }else{
			// 	$godos['is_number_goods']=0;
			// }
			...
			$goods['qiangg_start_time']=$data['status'];
			$goods['qiangg_end_time']=$data['status'];
