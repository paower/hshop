<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./themes/default/member/member_backend\add.html";i:1567739793;s:34:"./shop/admin/view/public/base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<div class="col-xs-12">	
		<div class="form-horizontal">
			<div class="form-group required">
				...
				<div class="col-sm-10">
					<input class="form-control USER" type="text" placeholder="账号ID" name="uid"  value="" />
				</div>
			</div>
