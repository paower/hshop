<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"./shop/admin\view\brand\edit.html";i:1569834532;s:45:"F:\web\Hshop\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
	<div class="col-xs-12">	
		...
		<div class="form-horizontal">
			...
			<div class="col-sm-5">
				<div class="clearfix">
				<input name="sort" class="col-xs-10 col-sm-5"  value="<?php echo (isset($d['sort']) && ($d['sort'] !== '')?$d['sort']:''); ?>" type="text">
				</div>
			</div>
			</div>
