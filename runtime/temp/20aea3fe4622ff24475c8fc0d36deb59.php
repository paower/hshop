<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./shop/admin\view\file_manager\index.html";i:1570334034;}*/ ?>
      ...
      <?php if(!empty($data['images'])){ foreach (array_chunk($data['images'], 4) as $image) { ?>
				      <div class="row">
				        ...
				        <div class="col-sm-3 text-center">
				          ...
				          <a class="thumbnail"><img src="/<?php echo $image['thumb']; ?>" alt="<?php echo $image['name']; ?>" title="<?php echo $image['name']; ?>" style="width: 100px;height:100px"/></a>
				          <label>
				            <input type="checkbox" name="path[]" value="<?php echo $image['path']; ?>" />
				            <?php echo $image['name']; ?></label>
				          <?php } ?>
