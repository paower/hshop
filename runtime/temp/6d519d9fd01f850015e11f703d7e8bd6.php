<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"./themes/default/index/user\myggao_detail.html";i:1569380473;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
...
<div class="near-box">
      ...
      <div class="discounts-bigbox">
		  ...
		  <div class="float-100">
		   ...
		   <div class="float-100">
				<span class="rule-title" style="color: red;">失败原因</span>
				<span class="news-center-text3" style="padding-left: 13px"><?php echo $info['reason']; ?></span>
		   </div>
		   <?php endif; ?>
      </div>
      <!--bigbox结束-->
