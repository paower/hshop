<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"./shop/admin\view\goods\edit.html";i:1570871402;s:46:"D:\web\hshop2\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
          ...
          <div class="tab-content">
	          	...
	          	<div class="tab-pane active" id="tab-data">
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input id="input-name2" class="form-control" type="text" placeholder="视频链接" value="" name="video">
						</div>
					</div>
		            <div class="form-group">
						...
						<div class="col-sm-10">
							...
							<select id="modelis" class="form-control" name="modelis">
									<option value="1" selected>分销价区</option>
									<option value="2">0元抢购</option>
									<option value="3">1元礼品</option>
									<option value="4">团购区</option>
									<option value="5">升级商品</option>
							</select>
						</div>
					</div>
		            <div class="form-group required">
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input id="input-meta-title2" class="form-control" type="text" placeholder="零售价格" value="" name="retail_price">
						</div>
					</div>
					
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-meta-title2" id="modelistext">分销价格：</label>
						<div class="col-sm-10">
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input id="input-meta-title2" class="form-control" type="text" placeholder="购买可得购物券" value="" name="points">
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">可用积分兑换：</label>
						<div class="col-sm-10">
							<label class="radio-inline">
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input id="input-meta-title2" class="form-control" type="text" placeholder="兑换所需购物券" value="" name="pay_points">
						</div>
					</div>
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-meta-title2">可用邀请名单：</label>
						<div class="col-sm-10">
							<input id="input-meta-title2" class="form-control" type="text" placeholder="可用邀请名单" value="" name="pay_number">
						</div>
					</div>
					<div class="form-group required">
						...
						<div class="col-sm-10">
							...
							<select id="input-length-class" class="form-control" name="length_class_id">
								...
								<?php if(is_array($transport) || $transport instanceof \think\Collection || $transport instanceof \think\Paginator): $i = 0; $__LIST__ = $transport;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									...
									<!-- <option value="<?php echo $v['length_class_id']; ?>">圆通</option>
									<option value="<?php echo $v['length_class_id']; ?>">韵达</option> -->
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
	          	...
	          	<div class="tab-pane" id="tab-general">	          		
					...
					<div class="form-group">
	                    ...
	                    <div class="col-sm-10">
	                      <textarea name="goods_description[description]" id="editor1"></textarea>	
	                    </div>
                  	</div>
...
$('#modelis').change(function () {
   var ids =  $("#modelis option:selected").val();   
	if(ids==2){
		$('#modelistext').text('抢购价格：');
	}else if(ids==3){
		$('#modelistext').text('礼品价格：');
	}else if(ids==4){
		$('#modelistext').text('团购价格：');
	}else if(ids==5){
	$('#modelistext').text('优惠价格：');
	}else{
