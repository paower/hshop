<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./themes/default/index/index\groupbuy.html";i:1570871523;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		<div class="near-box">
			...
			<div class="discounts-bigbox">
				<div class="discounts-banner1"><img src="<?php echo $grouplist_pic; ?>" alt=""></div>
				<?php if(is_array($grouplist) || $grouplist instanceof \think\Collection || $grouplist instanceof \think\Paginator): $index = 0; $__LIST__ = $grouplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($index % 2 );++$index;?>
					...
					<div class="discounts-box1">
						...
						<div class="discounts-box2">
							<span class="d-box2-text1"><?php echo $item['name']; ?></span>
								...
								<span class="d-box2-text2">团购价：￥<?php echo $item['price']; ?> </span>
						</div>
					</div>
					</a>
