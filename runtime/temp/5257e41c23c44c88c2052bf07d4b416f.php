<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"./shop/admin\view\settings\other.html";i:1570525910;s:46:"D:\web\hshop2\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="form-horizontal">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-left">邀请好友背景图 </label>
				<div class="col-sm-10">
					<div class="clearfix">
						<a href="#" id="thumb-icon" data-toggle="image" class="img-thumbnail">
							<img src="/public/uploads/<?php echo $invite_background; ?>" alt="" style="width: 100px;height:200px">
							<input type="hidden" name="invite_background" value="<?php echo (isset($invite_background) && ($invite_background !== '')?$invite_background:''); ?>" id="input-image" />
						</a>
					</div>
				</div>
			</div>
			...
			<legend>注册协议 </legend>
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-left">注册协议 </label>
				<div class="col-sm-10">
					<div class="clearfix">
						<textarea name="regis_xieyi" id="input-meta-description2" style="display: block;width: 100%;height: 400px"><?php echo $regis_xieyi; ?></textarea>
					</div>
				</div>
			</div>
		</div>
...
<script>
	...
	{
		editor = K.create('textarea[name="regis_xieyi"]',
			{
	...
	$('#send').click(function(){
		...
		var url = "<?php echo url('Settings/save'); ?>";
