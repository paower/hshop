<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:39:"./themes/default/index/login\login.html";i:1569119121;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<title>登录</title>
		...
		<div class="near-box">
			<div class="index-bigbox" style="margin-top: 0px;">
				...
				<div class="personal-box5" style="background: none;">
					...
					<input style=" width: 45%;float: left;margin-top: 14px;" name="captcha" id="captcha" type="text" placeholder="请输入验证码" />
