<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./themes/default/member/member_backend\info.html";i:1569555049;s:34:"./shop/admin/view/public/base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div class="tab-pane active" id="tab-member">
			<table class="table table-binfoed">
				...
				<tr>
					<td>等级</td>
					<td>
						<select class="USER" id="vip_grade" name="vip_grade">
							<option value="1" <?php if($data['info']['vip_grade'] == 1): ?>selected<?php endif; ?>>体验用户</option>
							<option value="2" <?php if($data['info']['vip_grade'] == 2): ?>selected<?php endif; ?>>分销商</option>
							<option value="3" <?php if($data['info']['vip_grade'] == 3): ?>selected<?php endif; ?>>区代理</option>
							<option value="4" <?php if($data['info']['vip_grade'] == 4): ?>selected<?php endif; ?>>合伙股东</option>
						</select>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<label class="radio-inline">
							<input class="GGAO" type="radio" <?php if($data['info']['is_ggao'] == 1): ?>checked<?php endif; ?> value="1" name="is_ggao">是
						</label>
						<label class="radio-inline">
							<input class="GGAO" type="radio" <?php if($data['info']['is_ggao'] == 0): ?>checked<?php endif; ?>  value="0" name="is_ggao">否
						</label>
					</td>
				</tr>
			</table>
		...
		<div class="tab-pane" id="tab-shipping">
  		...
  		<div class="tab-pane" id="tab-money">
			<table class="table table-binfoed">
				...
				<tr>
				    <td>体验用户数量</td>
				    <td><input class="WALLET" name="number" type="number" style="width:400px;" value="<?php echo $wallet['number']; ?>" /></td>
				</tr> 
			</table>
			<div class="form-group">
				<div style="margin-left:20px;">
...
$('#btn').click(function(){
	...
	$.post(
		'<?php echo url("MemberBackend/edit"); ?>',
		{
			...
			is_ggao:$('.GGAO:radio:checked').val(),
