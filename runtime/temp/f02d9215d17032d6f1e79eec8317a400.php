<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"./themes/default/index/user\bill.html";i:1571035898;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
	                    ...
	                    <a href="javascript:;" class="aui-cells-cell">
	                    	<?php if($item['type'] == 1): ?>
		                        <div class="aui-cell-hd">
		                            <h4>充值</h4>
		                            <p>
		                            	<span><?php echo date("Y-m-d H:i:s",$item['creation_time']); ?></span>
		                            </p>
		                        </div>
	                        	<div>
							...
							<?php elseif($item['type'] == 8): ?>
		                        ...
		                        <div>
		                        	<p>-<?php echo (int)$item['price'];?>邀请购物券兑换</p>
		                        	<p class="p_text">
	                            		<?php if($item['state'] == 1): ?>
	                            			平台审核中
	                            		<?php elseif($item['state'] == 2): ?>
							...
							<?php elseif($item['type']==11): ?>
								<div class="aui-cell-hd">
									<h4><?php echo db('user')->where('user_id',$item['pay_uid'])->value('user_phone')?>升级</h4>
									<p>
										<span><?php echo date("Y-m-d H:i:s",$item['creation_time']); ?></span>
									</p>
								</div>
