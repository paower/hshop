<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"./shop/admin\view\goods\image.html";i:1562996944;s:46:"D:\web\hshop2\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<script>
	...
	function addImage() {
		...
		html += '  <td class="text-left"><a href="#" id="thumb-image' + image_row +
			'"data-toggle="image" class="img-thumbnail"><img src="/public/static/image/no_image_100x100.jpg" /><input type="hidden" name="goods_image[' +
