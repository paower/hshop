<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./themes/default/index/order\details.html";i:1569322071;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
...
<div class="near-box">
    ...
    <div class="jd-qrdd-bigbox">
        ...
        <div class="jd-qrdd-a1">
        	<span class="qrdd-a1-t1"><?php echo !empty($order['name2'])?$order['name2']:$order['shipping_name']; ?></span>
        	<span class="qrdd-a1-t1"><?php echo !empty($order['telephone'])?$order['telephone']:$order['shipping_tel']; ?></span>
        	<?php if($order['def'] == 2): ?>
        	...
        	<div class="qrdd-a1-b1">
        		...
        		<span class="qrdd-a1-t3"><?php echo get_area_name($order['shipping_province_id']); ?> <?php echo get_area_name($order['shipping_city_id']); ?> <?php echo get_area_name($order['shipping_country_id']); ?> <?php echo $order['shipping_address']; ?></span>
				<?php else: ?>
        ...
        <div class="zjzz-buylist-goods1">
	                ...
	                <div class="zjzz-buylist-gdetail">
	                	<div>
		                    ...
		                    <span class="zjzz-buylist-gmoney">
		                        <i class="zjzz-buylist-gm1">￥<?php echo $order['price']; ?></i>
            ...
            <div class="zjzz-buylist-btn">
				...
				<a href='<?php echo url("Order/tracking",array("order_id"=>$order["order_id"])); ?>' class="zjzz-buylist-btn3" style="margin-right: 10px;color: black;background: #ffffff;border: 1px solid #b0b2bf;">查看物流</a>
            </div>
        </div>
        <!--商品金额部分-->
