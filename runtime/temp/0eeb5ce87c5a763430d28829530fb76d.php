<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./themes/default/index/order\orderlist.html";i:1568966903;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
			...
			<div class="zjzz-buylist-m1">
				...
				<div class="zjzz-buylist-goods1">
					...
					<div class="zjzz-buylist-btn">
						...
						<a href="javascript:" class="zjzz-buylist-btn1" onclick="quxiao('<?php echo $dfkitem['order_id']; ?>')">取消订单</a>
					</div>
				</div>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</div>
