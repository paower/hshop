<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./themes/default/member/order_backend\index.html";i:1569653818;s:34:"./shop/admin/view/public/base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<table class="table table-striped table-bordered table-hover search-form">
	<thead>
		...
		<th><input name="start_time"" type="text" id="test1" placeholder="开始时间" value="<?php echo input('param.order_num'); ?>" /></th>
		<th><input name="end_time" type="text" id="test2" placeholder="结束时间" value="<?php echo input('param.user_name'); ?>" /></th>
		<th>
			<a class="btn btn-primary" href="javascript:;" id="search" url="<?php echo url('OrderBackend/index'); ?>">查询</a>
			<a class="btn btn-primary" href="javascript:;" id="daochu" url="<?php echo url('OrderBackend/derivedExcel'); ?>">导出</a>
		</th>
	</thead>
</table>	
