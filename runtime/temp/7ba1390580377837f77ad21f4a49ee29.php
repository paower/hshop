<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./shop/admin\view\settings\noticeadd.html";i:1568193443;s:67:"C:\phpStudy\PHPTutorial\WWW\hshop2\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
	<div class="col-xs-12">	
		<div class="form-horizontal">	
			...
			<div class="col-sm-10">
				<div class="clearfix">
					<select class="form-control" name="cate">
						<option <?php if($info['cate']==1): ?>selected<?php endif; ?> value="1">系统公告</option>
						<option <?php if($info['cate']==2): ?>selected<?php endif; ?> value="2">常见问题</option>
					</select>
				</div>
			</div>
			</div>
			...
			<div class="col-sm-10">
				<div class="clearfix">
					<input name="title" class="col-xs-10 col-sm-10 form-control"  value="<?php echo (isset($info['title']) && ($info['title'] !== '')?$info['title']:''); ?>" type="text">
				</div>
			</div>
			</div>
			...
			<div class="col-sm-10">
				<div class="clearfix">
					<textarea name="content" id="input-meta-description2" class="form-control" rows="5" ><?php echo (isset($info['content']) && ($info['content'] !== '')?$info['content']:''); ?></textarea>
				</div>
			</div>
			</div>
			...
			<div class="col-sm-10">
				<div class="clearfix">					
						<label class="radio-inline"><input  type="radio" value="1" name="status" <?php if($info['status'] == 1): ?>checked<?php endif; ?>>显示</label>	
						<label class="radio-inline"><input type="radio" value="0" name="status" <?php if($info['status'] == 0): ?>checked<?php endif; ?>>隐藏</label>				
				</div>
			</div>
			</div>
...
$('#send').click(function(){
	if(<?php echo $type; ?>==2){
		var url = "<?php echo url('Settings/notice_edit'); ?>";
	}else{
		var url = "<?php echo url('Settings/notice_add'); ?>"
	}
	$.post(
		url,
