<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./shop/admin\view\settings\frontend.html";i:1569835019;s:45:"F:\web\Hshop\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
			...
			<table id="images" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<tr id="gallery-image-row<?php echo $image_row; ?>">
						...
						<td class="text-right">
							<input type="text" name="frontend_images[<?php echo $image_row; ?>][href]" value="<?php echo $goods_image['href']; ?>"
								class="form-control" /></td>
						<td class="text-left">
