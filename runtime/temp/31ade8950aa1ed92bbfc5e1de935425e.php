<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"./shop/admin\view\settings\notice.html";i:1570500543;s:46:"D:\web\hshop2\shop\admin\view\public\base.html";i:1562121180;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('Settings/notice_add'); ?>" class="btn btn-primary">新增</a>
</div>		
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>							
							...
							<td>
								<?php switch($a['status']): case "1": ?><a href='<?php echo url("Settings/set_notice",array("id"=>$a["id"],"status"=>0)); ?>'><span class="btn btn-xs btn-success"><i class="fa fa-check bigger-120"></i></span></a><?php break; case "0": ?><a href='<?php echo url("Settings/set_notice",array("id"=>$a["id"],"status"=>1)); ?>'><span class="btn btn-xs btn-danger"><i class="fa fa-remove bigger-120"></i></span></a><?php break; endswitch; ?>								
							</td>							
							<td>
								<a  class="btn btn-xs btn-info" href='<?php echo url("Settings/notice_edit",array("id"=>$a["id"])); ?>'>
									<i class="fa fa-edit bigger-120"></i>
								</a> 
								<a class="delete btn btn-xs btn-danger" href='javascript:' onclick="del('<?php echo $a['id']; ?>')">
...
function del(id){
 	...
 	$.get("<?php echo url('Settings/notice_del'); ?>",{id:id}, function(res){
	    if(res.status==1){
	    	location.reload();
	    }else{
	    	alert('删除失败');
