<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./themes/default/index/user\setaddress.html";i:1570517104;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="near-box">
	...
	<div class="bigbox">
	    ...
	    <div class="receiv-box2" style="font-size: 13px;">
	     	...
	     	<input type="radio" name="Default" value="2" <?php if($address['default'] != 1): ?>checked="checked"<?php endif; ?>/>是
